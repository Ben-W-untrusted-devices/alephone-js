...
| Attract mode (auto-playing demos) | Working | the main menu plays a demo film after 30s idle, as it does natively; toggled by Preferences → Environment → "Play Demos When Idle" |
